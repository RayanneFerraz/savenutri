export const translations = {
  ...
  fr: {
    ...
    timerTitle: "Minuteur de Jeûne",
    timerSubtitle: "Suivez votre jeûne en temps réel",
    startTimer: "Démarrer le minuteur",
    viewProgress: "Voir le progrès",
    progressPageTitle: "Suivez Votre Progrès",
    progressPageSubtitle: "Surveillez votre historique de jeûne, poids et autres métriques importantes.",
    myProgress: "Mon Progrès",
    trackYourJourney: "Suivez votre parcours de jeûne intermittent",
    overview: "Aperçu",
    weight: "Poids",
    fasting: "Jeûne",
    wellness: "Bien-être",
    ...
    progressOverviewTitle: "Vue d'ensemble du progrès",
